package be.intecbrussel.basis.exercise08_09.graphics;
...
public class RectangleApp {
	public static void main(String[] args) {
		...
		System.out.println("Number of rectangles: "+ Rectangle.count);
		System.out.println("Number of angles: "+ Rectangle.ANGLES);		
	}
