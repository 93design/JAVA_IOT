...
public class LessonThirteen {
	...
	public static void main(String[] args) {
		...
		String gotToQuote = "He \n said, \"I'm here\"";

		/*
		 * Other common Escape Codes \n : Newline \b : Backspace \' : Apostrophe \" :
		 * Quote \\ : Backslash
		 */
		...
		/*
		 * You convert primitive types to a string with toString String byteString =
		 * Byte.toString(bigByte); String shortString = Short.toString(bigByte); String
		 * intString = Integer.toString(bigInt); String longString =
		 * Long.toString(bigByte); String floatString = Float.toString(bigByte); String
		 * doubleString = Double.toString(bigByte); String booleanString =
		 * Boolean.toString(bigByte);
		 * 
		 * You convert from String to primitives with parse int stringToInt =
		 * Integer.parseInt(intString); parseSort, parseLong, parseByte, parseDouble,
		...
		/*
		 * StringBuilders also have the same methods as Strings charAt(), indexOf(),
