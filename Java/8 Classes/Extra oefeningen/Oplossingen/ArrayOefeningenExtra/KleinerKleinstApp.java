...
public class KleinerKleinstApp {
	public static void main(String[] args) {
		int arr[] = { 5, 7, -8, 5, 14, -6 };
		...
		first_element = second_element=500000;
		...
		if (second_element == Integer.MAX_VALUE)
			...
			System.out.println("The smallest element is " + first_element + " and second Smallest  element is "
					+ second_element + ".");
